...
4. the code is written in .NET 8 so it's platform indipendent. On Windows though it's intended to be run as Windows Service. Look at [this](TunnelProxy/README.md) README for details on how to create
   system service.
